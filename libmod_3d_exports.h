...
//    "DOUBLE size_y=100.0;\n"
    ...
    /* Sembrado (C3D_SCATTER): balanceo, distancia a la que deja de dibujarse y
       si bloquea el paso. Como cualquier otro local, cambiarlos en el LOOP se
       aplica solo en el siguiente FRAME. */
    "DOUBLE wind=0.0;\n"
...
DLSYSFUNCS __bgdexport(libmod_3d, functions_exports)[] = {
    ...
    FUNC("G3D_LAKE_ADD_R", "FFFFF", TYPE_INT, g3d_lake_add_r_bgd),
    ...
    FUNC("G3D_RIVER_FALLS", "", TYPE_INT, g3d_river_falls_bgd),
