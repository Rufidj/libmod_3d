...
/* Marca la entidad como solida (caja del AABB del mesh). Ademas de la colision,
   es lo que hace que el agua la vea: una roca solida en un rio lo desvia y
   salpica; una que no lo es, la atraviesa. */
